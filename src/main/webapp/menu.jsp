                ...
                <TABLE cellSpacing=0 cellPadding=3 width=165 align=center border=0>
                            ...
                            <TABLE id=table_1 style="DISPLAY: none" cellSpacing=0
                                ...
                                <TR>
                                    <TD class=menuSmall><A class=style2
                                                           href="${pageContext.request.contextPath }/customer_add.action"
                                                           target=main>－ 新增客户</A></TD>
                                </TR>
                                <TR>
                                    <TD class=menuSmall><A class=style2
                                                           href="${pageContext.request.contextPath }/customer_list.action"
                                                           target=main>－ 列表客户</A></TD>
                                </TR>
                                <TR>
                                    <TD class=menuSmall><A class=style2
                                                           href="${pageContext.request.contextPath }/customer_page.action?pageCode=1"
                                                           target=main>－ 分页客户</A></TD>
                                </TR>
                    ...
                    <TR>
                        <TD>
                            <TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
                                ...
                                <TR>
                                    <TD class=menuSmall><A class=style2
                                                           href="${pageContext.request.contextPath }/contacter_add.action"
                                                           target=main>－ 新增联系人</A></TD>
                                </TR>
                                <TR>
                                    <TD class=menuSmall><A class=style2
                                                           href="${pageContext.request.contextPath }/contacter_list.action"
                                                           target=main>－ 列表联系人</A></TD>
                                </TR>
                    ...
                    <TR>
                        <TD class=mainMenu onClick="MenuDisplay('table_5');"><SPAN
                                class=span id=table_5Span>＋</SPAN> 拜访管理
                        </TD>
                    </TR>
                    <TR>
                        <TD>
                            <TABLE id=table_5 style="DISPLAY: none" cellSpacing=0
                                ...
                                <TR>
                                    <TD class=menuSmall><A class=style2
                                                           href="${pageContext.request.contextPath }/visit_add.action"
                                                           target=main>－ 新增拜访</A></TD>
                                </TR>
                                <TR>
                                    <TD class=menuSmall><A class=style2
                                                           href="${pageContext.request.contextPath }/visit_list.action"
                                                           target=main>－ 拜访列表</A></TD>
                                </TR>
                    ...
                    <TR>
                        <TD>
                            <TABLE id=table_3 style="DISPLAY: none" cellSpacing=0
                                ...
                                <TR>
                                    <TD class=menuSmall><A class=style2
                                                           href="${pageContext.request.contextPath }/customer_where.action"
                                                           target=main>－ 客户查询</A></TD>
                                </TR>
                                <TR>
                                    <TD class=menuSmall><A class=style2
                                                           href="${pageContext.request.contextPath }/contacter_where.action"
                                                           target=main>－ 联系人查询</A></TD>
                                </TR>
                                <TR>
                                    <TD class=menuSmall><A class=style2
                                                           href="${pageContext.request.contextPath }/visit_where.action"
                                                           target=main>－ 拜访查询</A></TD>
                                </TR>
                                </TBODY>
                            </TABLE>
                        </TD>
                    ...
                    <TR>
                        <TD class=mainMenu onClick="MenuDisplay('table_4');"><SPAN
                                class=span id=table_4Span>＋</SPAN> 客户统计分析
                        </TD>
                    </TR>
                    <TR>
                        <TD>
                            <TABLE id=table_4 style="DISPLAY: none" cellSpacing=0
                                ...
                                <TR>
                                    <TD class=menuSmall><A class=style2
                                                           href="${pageContext.request.contextPath }/customer_level.action"
                                                           target=main>－客户级别统计</A></TD>
                                </TR>
                                <TR>
                                    <TD class=menuSmall><A class=style2
                                                           href="${pageContext.request.contextPath }/customer_source.action"
