...
<FORM id=form1 name=form1
      action="${pageContext.request.contextPath }/customer_insert.action"
      method=post>
                ...
                <TABLE cellSpacing=0 cellPadding=5 border=0>
                    <TR>
                        ...
                        <td><INPUT class=textbox id=sChannel2 style="WIDTH: 180px"
                                   maxLength=50 name="customerName"></td>
                    </TR>
                    <TR>
                        <td>客户级别：</td>
                        <td>
                    ...
                    <TR>
                        <td>固定电话：</td>
                        <td><INPUT class=textbox id=sChannel2 style="WIDTH: 180px"
                                   maxLength=50 name="customerPhone" value="1234567890"></td>
                        <td>移动电话：</td>
                        <td><INPUT class=textbox id=sChannel2 style="WIDTH: 180px"
                                   maxLength=50 name="customerMoblie" value="1234567890"></td>
                    </TR>
                    <TR>
