				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：综合查询 &gt; 拜访查询</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
						...
						<TABLE cellSpacing=0 cellPadding=5 border=0>
							<tr>
								...
								<td>所属客户</td>
								<td><select name="customer.customerId">
							...
							<TR>
								...
								<td><INPUT class=textbox id=sChannel2 style="WIDTH: 180px"
									maxLength=50 name="visitAddress" value="湖北武汉"></td>
								<td>拜访内容：</td>
								<td><INPUT class=textbox id=sChannel2 style="WIDTH: 180px"
									maxLength=50 name="visitContent" value="谈生意"></td>
								</td>
							</TR>
							<TR>
